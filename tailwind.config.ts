...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        "gradient-gold": "linear-gradient(135deg, hsl(38 70% 50%), hsl(45 80% 65%))",
      ...
      boxShadow: {
        "gold": "0 0 60px hsl(38 65% 55% / 0.15)",
        "gold-strong": "0 0 80px hsl(38 65% 55% / 0.25)",
        "glow": "0 0 40px hsl(38 65% 55% / 0.3)",
